    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps
                ...
                .Where(g => g.Count() > 1)
                .Select(g => new { name = g.First().Deptno, numOfEmployees = g.Count() });
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => Emps.Any(e2 => e2.Mgr == e.Mgr))
                .OrderBy(e => e.Ename)
        ...
        public static IEnumerable<Dept> Task15()
        {
            ...
            result = Emps
                ...
                .Select(g => new Dept { Deptno = (int)g.Key });
            return result;
        }
        ...
        public static IEnumerable<Dept> Task16()
        {
            IEnumerable<Dept> result = null;
            result =Emps
                .Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => dept);
            return result;
        }
    }
